 ...
 * @author vivi-barrios
 */
public class CrearLIbros extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("AGREGAR LIBROS AL INVENTARIO");
    ...
    private boolean ValidarDatos(){
        LIBROS l = new LIBROS();
        l.genero = gen.getText();
        if(!l.genero.matches("[a-zA-Z\\s]+")){
            JOptionPane.showMessageDialog(this, "El campo solo admite letras");
            return false;
        }
        
        l.autor = autores.getText();
        if(!l.autor.matches("[a-zA-Z\\s]+")){
            JOptionPane.showMessageDialog(this, "El campo solo admite letras");
            return false;
        }
        
        l.cantidad = cant.getText();
        if(!l.cantidad.matches("\\d+")){
         JOptionPane.showMessageDialog(this, "Ingrese solo valores numericos");
         return false;
        }
        
        try{
        l.precio = Double.parseDouble(precios.getText());
    ...
    private void GUARDARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GUARDARActionPerformed
        ...
        try (BufferedWriter bw = new BufferedWriter (new FileWriter("Libros.txt",true))){
            bw.write(l.titulo + "," + l.autor + "," + l.genero + "," + l.precio + "," + l.cantidad);
            bw.newLine();
